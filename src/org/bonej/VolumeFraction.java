...
@Plugin(menuPath = "Plugins>BoneJ>Volume Fraction")
public class VolumeFraction implements ImageJPlugin {
	
	@Parameter(required = true, persist = false)
	private DatasetView view;
	
	@Parameter(label = "Image Type", type = ItemIO.OUTPUT)
	private String imageType;
	
	@Parameter(label = "Volume Fraction", type = ItemIO.OUTPUT)
	private String output;
	
	private double threshold = 128; //testing value for binary image
